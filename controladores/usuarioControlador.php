...
VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
        ...
        if ($stmt->execute()) {
                ...
                $_SESSION['usuario'] = $nombre; // Guardar el nombre en la sesión=======session_start();
                $_SESSION['usuario'] = $nombre; // Guardar el nombre en la sesión>>>>>>> 436c71b (Restaurando el repositorio)
